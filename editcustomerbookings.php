...
<div class="container">
    ...
    <hr>
    <div class="col-md-6">
        <form action="include/editcustomerbookings.inc.php" method="POST">
            ...
            <input id="venuename" class="form-control" name="venuename" value= "<?php echo $venue['venue_name'];?>" readonly>
